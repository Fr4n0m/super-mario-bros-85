function createAnimations() {
  ...
  this.anims.create({
    ...
    frames: this.anims.generateFrameNumbers("ground-coin", {
      start: 2,
      end: 0,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    ...
    frames: this.anims.generateFrameNumbers("mistery-block", {
      start: 2,
      end: 0,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    ...
    frames: this.anims.generateFrameNumbers("custom-block", {
      start: 2,
      end: 0,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    ...
    frames: this.anims.generateFrameNumbers("brick-debris", {
      start: 0,
      end: 3,
    }),
    frameRate: 4,
  ...
  this.anims.create({
    ...
    frames: this.anims.generateFrameNumbers("fire-flower", {
      start: 0,
      end: 3,
    }),
    frameRate: 10,
