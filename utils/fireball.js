...
function fireballBounce(fireball, collider) {
  if (
    (collider.isPlatform &&
      (fireball.body.blocked.left || fireball.body.blocked.right)) ||
    (!collider.isPlatform &&
      (fireball.body.blocked.left || fireball.body.blocked.right))
  ) {
    fireball.exploded = true;
  ...
  if (fireball.body.blocked.down) fireball.setVelocityY(-levelGravity / 3.45);

  if (fireball.body.blocked.up) fireball.setVelocityY(levelGravity / 3.45);
