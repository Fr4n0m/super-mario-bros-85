...
function drawSettingsMenu() {
  ...
  let settingsBackground = this.add
    .rectangle(0, screenHeight / 2, worldWidth, screenHeight, 0x171717, 0.95)
    .setScrollFactor(0);
  settingsBackground.depth = 4;
  this.settingsMenuObjects.add(settingsBackground);

  let settingsXbutton = this.add
    .text(screenWidth * 0.94, screenHeight - screenHeight * 0.9, "x", {
  ...
  let settingsText = this.add.text(
    screenWidth / 6,
    screenHeight - screenHeight * 0.85,
    "Settings",
    { fontFamily: "pixel_nums", fontSize: screenWidth / 45, align: "center" }
  );
  ...
  let musicCheckboxText = this.add
    .text(screenWidth / 8, screenHeight / 2.9, "Music", {
      fontFamily: "pixel_nums",
  ...
  let effectsCheckboxText = this.add
    .text(screenWidth / 8, screenHeight / 2.3, "Effects", {
      fontFamily: "pixel_nums",
      fontSize: screenWidth / 55,
      align: "center",
    })
  ...
  sliderBar
    .lineStyle(5, 0x373737, 1)
    .strokePoints(sliderDot.slider.endPoints).depth = 4;
  this.settingsMenuObjects.add(sliderBar);

  let sliderDotText = this.add
    .text(screenWidth / 5.15, screenHeight / 1.85, "General volume", {
      fontFamily: "pixel_nums",
  ...
  let sliderPercentageText = this.add
    .text(
      screenWidth / 5.15,
      screenHeight / 1.5,
      Math.trunc(sliderDot.slider.value * 100),
      { fontFamily: "pixel_nums", fontSize: screenWidth / 80, align: "center" }
    )
    .setOrigin(0.5, 0);
  ...
  let controlsText = this.add.text(
    screenWidth / 1.5,
    screenHeight - screenHeight * 0.85,
    "Controls",
    { fontFamily: "pixel_nums", fontSize: screenWidth / 45, align: "center" }
  ...
  const displayChar = (charCode) =>
    specialCharMap[charCode] || String.fromCharCode(charCode);
  ...
  const directionTexts = [
    {
      ...
      text: this.add.text(
        screenWidth / 1.37,
        screenHeight / 2.25,
        displayChar(controlKeys.JUMP.keyCode),
        {
          fontFamily: "pixel_nums",
          fontSize: screenWidth / 55,
          align: "center",
      ...
      icon: this.add
        .sprite(screenWidth / 1.37, screenHeight / 2, "mario")
        .setScale(screenHeight / 500)
        .setOrigin(0.5)
        .anims.play("jump"),
    },
    {
      ...
      text: this.add.text(
        screenWidth / 1.37,
        screenHeight / 1.75,
        displayChar(controlKeys.DOWN.keyCode),
        {
          fontFamily: "pixel_nums",
          fontSize: screenWidth / 55,
          align: "center",
      ...
      icon: this.add
        .sprite(screenWidth / 1.37, screenHeight / 1.68, "mario-grown")
        .setScale(screenHeight / 550)
        .setOrigin(0.6, 0)
    ...
    },
    {
      ...
      text: this.add.text(
        screenWidth / 1.5,
        screenHeight / 1.75,
        displayChar(controlKeys.LEFT.keyCode),
        {
          fontFamily: "pixel_nums",
          fontSize: screenWidth / 55,
          align: "center",
      ...
      icon: this.add
        .sprite(screenWidth / 1.56, screenHeight / 1.75, "mario")
        .setScale(screenHeight / 500)
        .setFlipX(true)
        .setOrigin(0.6, 0.5),
    },
    {
      ...
      text: this.add.text(
        screenWidth / 1.26,
        screenHeight / 1.75,
        displayChar(controlKeys.RIGHT.keyCode),
        {
          fontFamily: "pixel_nums",
          fontSize: screenWidth / 55,
          align: "center",
      ...
      icon: this.add
        .sprite(screenWidth / 1.22, screenHeight / 1.75, "mario")
        .setScale(screenHeight / 500)
        .setOrigin(0.6, 0.5),
    },
    {
      ...
      text: this.add.text(
        screenWidth / 1.65,
        screenHeight / 2.5,
        displayChar(controlKeys.FIRE.keyCode),
        {
          fontFamily: "pixel_nums",
          fontSize: screenWidth / 55,
          align: "center",
      ...
      icon: this.add
        .sprite(screenWidth / 1.65, screenHeight / 2.25, "fireball")
    ...
    text.on(
      ...
      function () {
        ...
        keydownHandler = function (event) {
          ...
          if (
            Object.values(controlKeys).some(({ keyCode }) => keyCode === key)
          ) {
