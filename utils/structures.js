  ...
  if (isLevelOverworld) {
      ...
      case 0:
        this.blocksGroup.add(
          this.add
            .tileSprite(
              pieceStart,
              screenHeight - platformHeight * 1.9,
              16,
              16,
              "block"
            )
        ...
        this.blocksGroup.add(
          this.add
            .tileSprite(
              pieceStart,
              screenHeight - platformHeight * 2.9,
              16,
              16,
              "block"
            )
    ...
    switch (random) {
      ...
      case 1:
        ...
        break;
      case 2:
        this.constructionBlocksGroup.add(
          this.add
            .tileSprite(
              pieceStart,
              screenHeight - platformHeight * 1.9,
        ...
        this.constructionBlocksGroup.add(
          this.add
            .tileSprite(
              pieceStart,
              screenHeight - platformHeight * 2.135,
              16,
              16,
              "block2"
            )
        ...
        this.constructionBlocksGroup.add(
          this.add
            .tileSprite(
              pieceStart,
              screenHeight - platformHeight * 2.37,
              16,
              16,
              "block2"
            )
        ...
        this.groundCoinsGroup.add(
          this.physics.add
            .sprite(
              pieceStart,
              screenHeight - platformHeight * 2.4,
              "ground-coin"
            )
            .setScale(screenHeight / 345)
            .setOrigin(3.75, 1.65)
